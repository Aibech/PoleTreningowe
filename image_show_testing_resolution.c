...
int main(int argc, char *argv[]) {
   ...
   while((opt =getopt(argc,argv, "f:t:h")) != -1){
    ...
    case 't':
        ...
        break;
    case 'h':
        printf("This app is used for showing image on screen.\n");
        printf(" ./app [ -f FILENAME ] [ -t TIME_ON_SCREEN_IN_SEC ] [ -h ]\n");
        break;
    default:
    ...
    struct drm_mode_create_dumb creq = {
        .height = mode.hdisplay,     //small issue potentially change width with height to repair issue with non-square images
        .width = mode.vdisplay,
        .bpp = 32,
    };
